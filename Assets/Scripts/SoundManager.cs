...
public class SoundManager : MonoBehaviour {
    ...
    private void Instance_OnRecipeFailed(object sender, System.EventArgs e) {
        ...
        PlaySound(audioClipRefsSO.delivryFail, deliveryCounter.transform.position);
    }
    ...
    private void PlaySound(AudioClip audioClip, Vector3 position, float volumeMultiplier = 3f) {
